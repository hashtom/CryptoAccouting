...
//using System.Xml.Serialization; using System.Threading.Tasks; using UIKit; using CryptoAccouting.UIClass; using CryptoAccouting.CoreClass.APIClass;  namespace CryptoAccouting.CoreClass {     public static class ApplicationCore     {         public const string AppName = "CryptoAccounting";         private static Balance myBalance;         private static List<Instrument> instruments;         public static NavigationDrawer Navigation { get; set; }
        ...
        {              if (DoRefresh)
            {                 instruments = new List<Instrument>();
                MarketDataAPI.FetchAllCoinData(instruments);                 instruments.Where(i => i.Symbol == "BTC").First().LogoFileName= "Images/btc.png";                 instruments.Where(i => i.Symbol == "ETH").First().LogoFileName = "Images/eth.png";                 instruments.Where(i => i.Symbol == "REP").First().LogoFileName = "Images/rep.png";                 StorageAPI.SaveInstrumentXML(instruments, "instruments.xml"); 
            }
            else
            {                 instruments = StorageAPI.LoadInstrumentXML("instruments.xml");             }          }          //public static Balance GetTestBalance(){
