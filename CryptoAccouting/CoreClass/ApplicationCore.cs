using System; using System.Collections.Generic; using System.Linq; //using System.Threading.Tasks; using System.IO; using UIKit; using CryptoAccouting.UIClass;  namespace CryptoAccouting.CoreClass {     public static class ApplicationCore     {         private static Balance myBalance;         private static List<Instrument> instruments;         public static NavigationDrawer Navigation { get; set; }         //private static List<Exchange> Exchanges;          public static NavigationDrawer InitializeSlideMenu(UIView thisview){             Navigation = new NavigationDrawer(thisview);             Navigation.AddView(thisview);             return Navigation;         }          public static void LoadInstruments(){              instruments = new List<Instrument>();
