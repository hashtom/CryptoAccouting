using Foundation; using System; using UIKit; using CryptoAccouting.CoreClass; using CryptoAccouting.UIClass; using System.Threading.Tasks;  namespace CryptoAccouting {     public partial class BalanceViewController : UITableViewController     {         //private Balance myBalance;         private NavigationDrawer menu;         static NSString MyCellId = new NSString("BalanceCell");          public BalanceViewController(IntPtr handle) : base(handle)         {             AppSetting.BaseCurrency = EnuBaseCCY.JPY;             NavigationItem.RightBarButtonItem = EditButtonItem; //test
        }           public override void ViewDidLoad()         {             base.ViewDidLoad();                                      // Instantiate Controllers             TransactionViewController transViewC = this.Storyboard.InstantiateViewController("TransactionViewC") as TransactionViewController;             PLViewController plViewC = this.Storyboard.InstantiateViewController("PLViewC") as PLViewController;             PerfomViewController perfViewC = this.Storyboard.InstantiateViewController("PerfViewC") as PerfomViewController;             SettingTableViewController settingViewC = this.Storyboard.InstantiateViewController("SettingTableViewC") as SettingTableViewController;             menu = ApplicationCore.InitializeSlideMenu(TableView, this, transViewC, plViewC, perfViewC, settingViewC);
    
            ApplicationCore.LoadInstruments(false);
